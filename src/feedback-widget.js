(function () {
  ...
  if (typeof import.meta !== 'undefined' && import.meta.env) {
    if (import.meta.env.VITE_TELEGRAM_BOT_TOKEN) {
      internalConfig.botToken = import.meta.env.VITE_TELEGRAM_BOT_TOKEN;
    }
    if (import.meta.env.VITE_TELEGRAM_CHAT_ID) {
      internalConfig.chatId = import.meta.env.VITE_TELEGRAM_CHAT_ID;
    }
  }

  window.WIDGET_CONFIG = internalConfig;

  // 0. Inject App CSS from remote host
  if (!document.querySelector('link[href*="index-DxiDtPaO.css"]')) {
    const appCss = document.createElement('link');
    appCss.rel = 'stylesheet';
    appCss.href = "https://019-site-git-agt2319.vercel.app/assets/index-DxiDtPaO.css";
